...
<span style="color:#d4d4d4">--data </span><span style="color:#ce9178">''appOrderID': int(apOrpderID), 'orderUniqueIdentifier': orderUniqueIdentifier'</span>
    </div>
...
<span style="color:#9cdcfe">params</span><span style="color:#d4d4d4"> = {</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#ce9178">"appOrderID"</span><span style="color:#d4d4d4">: </span><span style="color:#ce9178">"1000125345"</span><span style="color:#ce9178">""</span><br>
<span style="color:#d4d4d4">}</span><br>
<span style="color:#9cdcfe">headers</span><span style="color:#d4d4d4"> = {</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#ce9178">"orderUniqueIdentifier"</span><span style="color:#d4d4d4">: </span><span style="color:#ce9178">"orderUniqueIdentifier"</span><br>
<span style="color:#d4d4d4">}</span><br>
<span style="color:#9cdcfe">response</span><span style="color:#d4d4d4"> = await self.</span><span style="color:#dcdcaa">_delete</span><span style="color:#d4d4d4">('</span><span style="color:#9cdcfe">order.cancel</span><span style="color:#d4d4d4">, params)</span><br>
<span style="color:#dcdcaa">return</span><span style="color:#d4d4d4"> </span><span style="color:#9cdcfe">self.</span><span style="color:#dcdcaa">_handle_response</span><span style="color:#dcdcaa">(</span><span style="color:#d4d4d4">response,</span><span style="color:#ce9178">"Cancel Order"</span><span style="color:#dcdcaa">)</span>
    </div>
