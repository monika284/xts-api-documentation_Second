...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:14px;margin:16px 0 24px">
  ...
  <div style="border:1.5px solid #bfdbfe;border-radius:12px;overflow:hidden">
    <div style="background:#1d4ed8;padding:10px 16px;color:#fff;font-weight:700;font-size:13px">Event 1501 — Touchline</div>
  ...
  <div style="border:1.5px solid #bbf7d0;border-radius:12px;overflow:hidden">
    <div style="background:#16a34a;padding:10px 16px;color:#fff;font-weight:700;font-size:13px">Event 1502 — Market Depth</div>
  ...
  <div style="border:1.5px solid #e9d5ff;border-radius:12px;overflow:hidden">
    <div style="background:#7c3aed;padding:10px 16px;color:#fff;font-weight:700;font-size:13px">Event 1505 — OHLC Candle</div>
  ...
  <div style="border:1.5px solid #fde68a;border-radius:12px;overflow:hidden">
    <div style="background:#d97706;padding:10px 16px;color:#fff;font-weight:700;font-size:13px">Event 1510 — Open Interest</div>
  ...
  <div style="border:1.5px solid #e5e7eb;border-radius:12px;overflow:hidden">
    <div style="background:#374151;padding:10px 16px;color:#fff;font-weight:700;font-size:13px">Event 1507 — Market Status</div>
