...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:14px;margin:16px 0 24px">
  ...
  <div style="border:1.5px solid #dbeafe;border-radius:12px;padding:16px;background:#eff6ff">
    <div style="font-size:22px;margin-bottom:6px"></div>
    <div style="font-weight:700;color:#1d4ed8;font-size:13px;margin-bottom:4px">Fair Usage</div>
    <p style="font-size:12px;color:#374151;margin:0">Ensures equal resource allocation among all users and clients.</p>
  </div>
  <div style="border:1.5px solid #bbf7d0;border-radius:12px;padding:16px;background:#f0fdf4">
    <div style="font-size:22px;margin-bottom:6px"></div>
    <div style="font-weight:700;color:#16a34a;font-size:13px;margin-bottom:4px">Reliability</div>
    <p style="font-size:12px;color:#374151;margin:0">Maintains consistent API performance and platform availability.</p>
  </div>
  <div style="border:1.5px solid #e9d5ff;border-radius:12px;padding:16px;background:#faf5ff">
    <div style="font-size:22px;margin-bottom:6px"></div>
    <div style="font-weight:700;color:#7c3aed;font-size:13px;margin-bottom:4px">Abuse Protection</div>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin:16px 0">
  <div style="border:2px solid #bbf7d0;border-radius:12px;overflow:hidden">
    <div style="background:#16a34a;padding:10px 16px;color:#fff;font-weight:700;font-size:13px;display:flex;align-items:center;gap:8px"><span>✅</span> Allowed — 10 req/sec limit</div>
    <div style="padding:14px 16px;background:#f0fdf4">
      <div style="font-family:monospace;font-size:13px;color:#166534;background:#dcfce7;border-radius:8px;padding:10px 14px;line-height:2">
        Request 1 &nbsp;→ ✓<br>
        Request 2 &nbsp;→ ✓<br>
        Request 3 &nbsp;→ ✓<br>
      ...
      <p style="font-size:12px;color:#16a34a;margin:8px 0 0;font-weight:600">10 requests within 1 second — accepted</p>
    </div>
  </div>
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:16px 0 24px">
  ...
  <div style="border:1.5px solid #dbeafe;border-radius:12px;padding:16px;background:#eff6ff">
    <div style="font-size:20px;margin-bottom:6px"></div>
    <div style="font-weight:700;color:#1d4ed8;font-size:13px;margin-bottom:4px">Cache Responses</div>
  ...
  <div style="border:1.5px solid #bbf7d0;border-radius:12px;padding:16px;background:#f0fdf4">
    <div style="font-size:20px;margin-bottom:6px"></div>
    <div style="font-weight:700;color:#16a34a;font-size:13px;margin-bottom:4px">Monitor Headers</div>
  ...
  <div style="border:1.5px solid #e9d5ff;border-radius:12px;padding:16px;background:#faf5ff">
    <div style="font-size:20px;margin-bottom:6px"></div>
    <div style="font-weight:700;color:#7c3aed;font-size:13px;margin-bottom:4px">Queue Requests</div>
  ...
  <div style="border:1.5px solid #fde68a;border-radius:12px;padding:16px;background:#fffbeb">
    <div style="font-size:20px;margin-bottom:6px"></div>
    <div style="font-weight:700;color:#92400e;font-size:13px;margin-bottom:4px">Avoid Polling</div>
  ...
  <div style="border:1.5px solid #99f6e4;border-radius:12px;padding:16px;background:#f0fdfa">
    <div style="font-size:20px;margin-bottom:6px">⏱</div>
    <div style="font-weight:700;color:#0f766e;font-size:13px;margin-bottom:4px">Respect Retry Intervals</div>
