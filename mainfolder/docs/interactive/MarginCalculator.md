...
<div style="display:flex;align-items:center;flex-wrap:wrap;gap:0;margin-bottom:24px">
  ...
  <div style="color: #ff6b00;font-size:20px;font-weight:700;padding:0 8px">→</div>
  <div style="background: #fdf6f0;border:1.5px solid #e5e7eb;border-radius:8px;padding:12px 18px;font-size:12px;font-weight:700;color: #f58e07;text-align:center;min-width:110px">
    <div style="font-size:18px;margin-bottom:4px"></div>
    Required Margin
  </div>
</div>
