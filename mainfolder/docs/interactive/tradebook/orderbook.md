<h1 id="orderbook" style="color:#ff6b00;font-weight:800;margin-bottom:6px">Order Book</h1>
...
<h2 id="ob-what" style="color:#1e293b;font-weight:700;margin:28px 0 10px">What is an Order Book?</h2>
...
The <strong>Order Book</strong> is a record of <strong>all the orders you have placed with your trading account</strong>. It shows the current status of each order — whether it is pending, executed, cancelled, rejected, or partially filled. An Order Book helps you track every order from the moment it is placed until it is completed or cancelled.
</div>

<div style="background:#f8fafc;border:1.5px solid #e2e8f0;border-radius:10px;padding:16px 20px;margin-bottom:24px;font-size:14px;color:#374151">
  <strong style="color:#ff6b00">Simple Definition:</strong> An Order Book is a list of all your buy and sell orders, along with their current status and details.
</div>

---

<h2 id="ob-why" style="color:#1e293b;font-weight:700;margin:28px 0 16px">Why is the Order Book Important?</h2>

<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:24px">
  <div style="background:#fff;border:1px solid #fed7aa;border-left:3px solid #ff6b00;border-radius:8px;padding:14px 16px;font-size:13px;color:#374151;font-weight:600">Track all placed orders</div>
  <div style="background:#fff;border:1px solid #fed7aa;border-left:3px solid #ff6b00;border-radius:8px;padding:14px 16px;font-size:13px;color:#374151;font-weight:600">Check if order is executed or pending</div>
  <div style="background:#fff;border:1px solid #fed7aa;border-left:3px solid #ff6b00;border-radius:8px;padding:14px 16px;font-size:13px;color:#374151;font-weight:600">View order price &amp; quantity details</div>
  <div style="background:#fff;border:1px solid #fed7aa;border-left:3px solid #ff6b00;border-radius:8px;padding:14px 16px;font-size:13px;color:#374151;font-weight:600">Modify or cancel eligible orders</div>
  <div style="background:#fff;border:1px solid #fed7aa;border-left:3px solid #ff6b00;border-radius:8px;padding:14px 16px;font-size:13px;color:#374151;font-weight:600">Monitor partially executed orders</div>
  <div style="background:#fff;border:1px solid #fed7aa;border-left:3px solid #ff6b00;border-radius:8px;padding:14px 16px;font-size:13px;color:#c2410c;font-weight:600">Avoid missed or duplicate orders</div>
</div>

---

<h2 id="ob-flow" style="color:#1e293b;font-weight:700;margin:28px 0 16px">How an Order Moves Through the Order Book</h2>
...
<div style="display:flex;flex-direction:column;gap:0;margin-bottom:24px">
  <div style="display:flex;align-items:stretch;gap:0">
    <div style="display:flex;flex-direction:column;align-items:center;width:40px;flex-shrink:0">
      <div style="width:32px;height:32px;border-radius:50%;background:linear-gradient(135deg,#ff7b00,#ff9500);display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:13px">1</div>
      <div style="width:2px;background:#fed7aa;flex:1;min-height:24px"></div>
    </div>
    <div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:12px 16px;margin:0 0 0 12px;flex:1;font-size:13px;color:#374151;font-weight:600;margin-bottom:6px">Place Order</div>
  </div>
  <div style="display:flex;align-items:stretch;gap:0">
    <div style="display:flex;flex-direction:column;align-items:center;width:40px;flex-shrink:0">
      <div style="width:32px;height:32px;border-radius:50%;background:linear-gradient(135deg,#ff7b00,#ff9500);display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:13px">2</div>
      <div style="width:2px;background:#fed7aa;flex:1;min-height:24px"></div>
    </div>
    <div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:12px 16px;margin:0 0 0 12px;flex:1;font-size:13px;color:#374151;font-weight:600;margin-bottom:6px">Order Received by Exchange</div>
  </div>
  <div style="display:flex;align-items:stretch;gap:0">
    <div style="display:flex;flex-direction:column;align-items:center;width:40px;flex-shrink:0">
      <div style="width:32px;height:32px;border-radius:50%;background:linear-gradient(135deg,#ff7b00,#ff9500);display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:13px">3</div>
      <div style="width:2px;background:#fed7aa;flex:1;min-height:24px"></div>
    </div>
    <div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:12px 16px;margin:0 0 0 12px;flex:1;font-size:13px;color:#374151;font-weight:600;margin-bottom:6px">Order Pending — waiting to match</div>
  </div>
  <div style="display:flex;align-items:stretch;gap:0">
    <div style="display:flex;flex-direction:column;align-items:center;width:40px;flex-shrink:0">
      <div style="width:32px;height:32px;border-radius:50%;background:linear-gradient(135deg,#ff7b00,#ff9500);display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:13px">4</div>
      <div style="width:2px;background:#fed7aa;flex:1;min-height:24px"></div>
    </div>
    <div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:12px 16px;margin:0 0 0 12px;flex:1;font-size:13px;color:#374151;font-weight:600;margin-bottom:6px">Matched with Another Order</div>
  </div>
  <div style="display:flex;align-items:stretch;gap:0">
    <div style="display:flex;flex-direction:column;align-items:center;width:40px;flex-shrink:0">
...
<h2 id="ob-example" style="color:#1e293b;font-weight:700;margin:28px 0 14px">Example Order Book</h2>
...
<h2 id="ob-statuses" style="color:#1e293b;font-weight:700;margin:28px 0 16px">Common Order Statuses</h2>
...
<h2 id="ob-reallife" style="color:#1e293b;font-weight:700;margin:28px 0 14px">Real-Life Example</h2>

<div style="background:#fff;border:1.5px solid #e5e7eb;border-radius:12px;padding:20px 24px;margin-bottom:24px">
  <p style="margin:0 0 14px;font-size:14px;color:#374151">Rahul places an order to buy <strong>100 shares of ABC Ltd.</strong> at <strong>₹500</strong>.</p>
...
<div style="background:linear-gradient(135deg,#f8e1d7,#ff9500);border-radius:12px;padding:18px 22px;margin-bottom:32px">
  <p style="margin:0;font-size:14px;color:#0c0c0c;line-height:1.8"><strong>In Simple Words:</strong> The Order Book is a complete record of all your buy and sell orders. It shows each order's details and current status — Pending, Filled, Partially Filled, Cancelled, or Rejected — so you can monitor every order from placement to completion.</p>
</div>

---

<h2 id="get-orderbook" style="color:#1e293b;font-weight:700;margin:28px 0 10px">Get Order Book</h2>
<p style="color:#6b7280;font-size:13px;margin:-4px 0 16px">Fetch all orders placed by the authenticated user along with their current status.</p>
...
<h3 id="ob-req-params" style="color:#1e293b;font-weight:700;margin:24px 0 10px;font-size:15px">Request Parameters</h3>
...
<h3 id="ob-res-params" style="color:#1e293b;font-weight:700;margin:24px 0 10px;font-size:15px">Response Body Parameters</h3>
...
<table class="api-table">
  ...
  <tbody>
    ...
    <tr><td><span class="enum-badge">AppOrderID</span></td><td>AppOrderID</td><td>Unique order ID assigned by the system</td></tr>
    <tr><td><span class="enum-badge">OrderReferenceID</span></td><td>OrderReferenceID</td><td>Unique ID to identify multi-leg orders</td></tr>
    <tr><td><span class="enum-badge">GeneratedBy</span></td><td>GeneratedBy</td><td>Source from which the operation was performed</td></tr>
    <tr><td><span class="enum-badge">ExchangeOrderID</span></td><td>ExchangeOrderID</td><td>Unique OrderID generated by the exchange</td></tr>
    <tr><td><span class="enum-badge">OrderCategoryType</span></td><td>OrderCategoryType</td><td>Represents order market type (e.g. NORMAL)</td></tr>
    <tr><td><span class="enum-badge">ExchangeSegment</span></td><td>ExchangeSegment</td><td>Exchange segment (NSECM, NSEFO, etc.)</td></tr>
    ...
    <tr><td><span class="enum-badge">OrderType</span></td><td>OrderType</td><td>Market, Limit, StopLimit, StopMarket</td></tr>
    <tr><td><span class="enum-badge">ProductType</span></td><td>ProductType</td><td>MIS, NRML, CNC, CO, BO</td></tr>
    <tr><td><span class="enum-badge">TimeInForce</span></td><td>TimeInForce</td><td>DAY, IOC, GTC, GTD, EOS</td></tr>
    <tr><td><span class="enum-badge">OrderPrice</span></td><td>Price</td><td>The price to execute the order at</td></tr>
    <tr><td><span class="enum-badge">OrderQuantity</span></td><td>Quantity</td><td>Quantity to transact</td></tr>
    <tr><td><span class="enum-badge">OrderStopPrice</span></td><td>Price</td><td>Trigger price for SL / SL-M orders</td></tr>
    <tr><td><span class="enum-badge">OrderStatus</span></td><td>OrderStatus</td><td>Current status of the order</td></tr>
    <tr><td><span class="enum-badge">OrderAverageTradedPrice</span></td><td>Price</td><td>Volume weighted average execution price</td></tr>
    <tr><td><span class="enum-badge">LeavesQuantity</span></td><td>Quantity</td><td>Remaining quantity still to be executed</td></tr>
    <tr><td><span class="enum-badge">CumulativeQuantity</span></td><td>Quantity</td><td>Total quantity executed so far</td></tr>
    <tr><td><span class="enum-badge">OrderDisclosedQuantity</span></td><td>Quantity</td><td>Disclosed quantity (for equity iceberg orders)</td></tr>
    <tr><td><span class="enum-badge">OrderGeneratedDateTime</span></td><td>Timestamp</td><td>Timestamp when the order was registered by the API</td></tr>
    <tr><td><span class="enum-badge">ExchangeTransactTime</span></td><td>Timestamp</td><td>Timestamp when the order was registered by the exchange</td></tr>
    <tr><td><span class="enum-badge">LastUpdateDateTime</span></td><td>Timestamp</td><td>Timestamp of the latest order state change</td></tr>
    <tr><td><span class="enum-badge">OrderExpiryDate</span></td><td>OrderExpiryDate</td><td>Expiry date for GTD (Good Till Date) orders</td></tr>
    ...
    <tr><td><span class="enum-badge">OrderUniqueIdentifier</span></td><td>OrderUniqueIdentifier</td><td>Echo-back field to identify the order (20 chars)</td></tr>
    <tr><td><span class="enum-badge">OrderLegStatus</span></td><td>OrderLegStatus</td><td>Order leg type (SingleOrderLeg, etc.)</td></tr>
    <tr><td><span class="enum-badge">BoLegDetails</span></td><td>BoLegDetails</td><td>Bracket Order leg details</td></tr>
    <tr><td><span class="enum-badge">IsSpread</span></td><td>Boolean</td><td>Indicates spread order or normal order</td></tr>
    <tr><td><span class="enum-badge">BoEntryOrderId</span></td><td>AppOrderID</td><td>Entry order ID for Bracket Orders</td></tr>
    <tr><td><span class="enum-badge">MessageCode</span></td><td>Integer</td><td>API MessageCode</td></tr>
    <tr><td><span class="enum-badge">MessageVersion</span></td><td>Integer</td><td>API Message Version</td></tr>
    <tr><td><span class="enum-badge">TokenID</span></td><td>Integer</td><td>API TokenID</td></tr>
    <tr><td><span class="enum-badge">ApplicationType</span></td><td>Integer</td><td>API Application Type</td></tr>
    <tr><td><span class="enum-badge">SequenceNumber</span></td><td>Integer</td><td>API SequenceNumber</td></tr>
  </tbody>
</table>

<h3 id="ob-res-json" style="color:#1e293b;font-weight:700;margin:24px 0 10px;font-size:15px">Response Body JSON</h3>

<div style="position:relative;margin:8px 0 24px">
  <div style="background:#1e1e1e;border-radius:10px;padding:20px;font-family:Consolas,monospace;font-size:13px;line-height:1.8;max-height:280px;overflow:hidden;transition:max-height .4s ease" id="ob-res-box">
...
&nbsp;&nbsp;<span style="color:#9cdcfe">"description"</span><span style="color:#d4d4d4">: </span><span style="color:#ce9178">"Success order book"</span><span style="color:#d4d4d4">,</span><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#9cdcfe">"ExchangeOrderID"</span><span style="color:#d4d4d4">: </span><span style="color:#ce9178">"1005239196374108"</span><span style="color:#d4d4d4">,</span><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#9cdcfe">"OrderPrice"</span><span style="color:#d4d4d4">: </span><span style="color:#b5cea8">254.55</span><span style="color:#d4d4d4">,</span><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#9cdcfe">"OrderAverageTradedPrice"</span><span style="color:#d4d4d4">: </span><span style="color:#b5cea8">250.4</span><span style="color:#d4d4d4">,</span><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#9cdcfe">"OrderExpiryDate"</span><span style="color:#d4d4d4">: </span><span style="color:#ce9178">"01-01-1980 00:00:00"</span><span style="color:#d4d4d4">,</span><br>
...
<span style="color:#ffd700">}</span>
  ...
  <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:8px">
    <button onclick="(function(){var t=document.getElementById('ob-res-box').innerText;navigator.clipboard.writeText(t).then(function(){var b=document.getElementById('ob-res-copy');b.textContent='Copied!';setTimeout(function(){b.textContent='Copy'},1500)})})()" id="ob-res-copy" style="background:#374151;color:#fff;border:none;border-radius:7px;padding:6px 18px;font-size:13px;font-weight:600;cursor:pointer">Copy</button>
    <button onclick="(function(){var b=document.getElementById('ob-res-box');var btn=document.getElementById('ob-res-show');if(b.style.maxHeight==='none'){b.style.maxHeight='280px';btn.textContent='Show Full'}else{b.style.maxHeight='none';btn.textContent='Show Less'}})()" id="ob-res-show" style="background:#374151;color:#fff;border:none;border-radius:7px;padding:6px 18px;font-size:13px;font-weight:600;cursor:pointer">Show Full</button>
  </div>
</div>
