...
<div style="border:1.5px solid #e5e7eb;border-radius:10px;padding:12px 16px;background:#f9fafb;display:flex;align-items:center;gap:12px;flex-wrap:wrap;margin:8px 0 24px">
  ...
  <code style="flex:1;font-size:13px;color:#1d4ed8;background:transparent;word-break:break-all">http://160.30.125.86:10955//interactive/orders/trades</code>
  <button onclick="navigator.clipboard.writeText('http://160.30.125.86:10955//interactive/orders/trades').then(()=>{this.textContent='Copied!';setTimeout(()=>this.textContent='Copy',1500)})" style="background:#1d4ed8;color:#fff;border:none;border-radius:7px;padding:6px 16px;font-size:13px;font-weight:600;cursor:pointer;flex-shrink:0">Copy</button>
</div>
...
<div style="margin:8px 0 24px">
  ...
  <div style="background:#1e1e1e;border-radius:0 6px 6px 6px;padding:20px;font-family:Consolas,monospace;font-size:13px;line-height:1.8;position:relative">
    ...
    <div id="tb-code-curl">
<span style="color:#d4d4d4">curl --location </span><span style="color:#ce9178">'https://xts.rmoneyindia.co.in:3000//interactive/orders/trades'</span><span style="color:#d4d4d4"> \</span><br>
...
<span style="color:#9cdcfe">resp</span><span style="color:#d4d4d4"> = </span><span style="color:#c586c0">await</span><span style="color:#d4d4d4"> xt_interactive_data.</span><span style="color:#dcdcaa">get_trade</span><span style="color:#d4d4d4">()</span><br>
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(210px,1fr));gap:12px;margin:16px 0 24px">
  ...
  <div style="border:1.5px solid #fed7aa;border-radius:10px;padding:14px 16px;background: #ffffff">
    <div style="font-weight:700;color: #ff6b00;font-size:13px;margin-bottom:6px">Order ID</div>
    <p style="font-size:12px;color: #374151;margin:0 0 6px">The ID of the order that generated this trade.</p>
    <code style="font-size:12px;color:#b45309">Order ID: 24071800012345</code>
  </div>

  <div style="border:1.5px solid #fed7aa;border-radius:10px;padding:14px 16px;background:#ffffff">
    <div style="font-weight:700;color:#ff6b00;font-size:13px;margin-bottom:6px">Trading Symbol</div>
  ...
  <div style="border:1.5px solid #fed7aa;border-radius:10px;padding:14px 16px;background:#ffffff">
    <div style="font-weight:700;color:#ff6b00;font-size:13px;margin-bottom:6px">Exchange Segment</div>
    <p style="font-size:12px;color:#374151;margin:0 0 6px">Exchange where the trade was executed.</p>
    <code style="font-size:12px;color:#b45309">NSECM / NSEFO / BSECM</code>
  </div>

  <div style="border:1.5px solid #fed7aa;border-radius:10px;padding:14px 16px;background:#ffffff">
    <div style="font-weight:700;color:#ff6b00;font-size:13px;margin-bottom:6px">Order Side</div>
    <p style="font-size:12px;color:#374151;margin:0 0 6px">Whether the trade was a buy or sell.</p>
    <code style="font-size:12px;color:#b45309">BUY / SELL</code>
  </div>

  <div style="border:1.5px solid #fed7aa;border-radius:10px;padding:14px 16px;background:#ffffff">
    <div style="font-weight:700;color:#ff6b00;font-size:13px;margin-bottom:6px">Product Type</div>
    <p style="font-size:12px;color:#374151;margin:0 0 6px">Trading product used for the order.</p>
    <code style="font-size:12px;color:#b45309">MIS / CNC / NRML / BO / CO</code>
  </div>
  ...
  <div style="border:1.5px solid #fed7aa;border-radius:10px;padding:14px 16px;background:#ffffff">
    <div style="font-weight:700;color:#ff6b00;font-size:13px;margin-bottom:6px">Executed Price</div>
    <p style="font-size:12px;color:#374151;margin:0 0 6px">The price at which the trade was executed.</p>
    <code style="font-size:12px;color:#b45309">₹2,850.50</code>
  </div>

  <div style="border:1.5px solid #fed7aa;border-radius:10px;padding:14px 16px;background:#ffffff">
    <div style="font-weight:700;color:#ff6b00;font-size:13px;margin-bottom:6px">Trade Value</div>
    <p style="font-size:12px;color:#374151;margin:0 0 6px">Price × Quantity = Total trade value.</p>
    <code style="font-size:12px;color:#b45309">₹2,850 × 100 = ₹2,85,000</code>
  </div>

  <div style="border:1.5px solid #fed7aa;border-radius:10px;padding:14px 16px;background:#ffffff">
    <div style="font-weight:700;color:#ff6b00;font-size:13px;margin-bottom:6px">Trade Time</div>
    <p style="font-size:12px;color:#374151;margin:0 0 6px">Exact time when the trade was executed.</p>
    <code style="font-size:12px;color:#b45309">09:24:18 AM</code>
  </div>
