  ...
  <div style="border:1.5px solid #fed7aa;border-radius:12px;overflow:hidden;background:#fff">
    <div style="background: #f97316;padding:12px 18px;display:flex;align-items:center;gap:10px">
      ...
      <div>
        ...
        <div style="color: #ffedd5;font-size:12px">Profit / loss from closed trades</div>
      </div>
    </div>
    <div style="padding:16px 18px">
      ...
      <div style="background: #ffff;border:1px solid #fed7aa;border-radius:8px;padding:12px 14px;margin-bottom:12px">
      ...
      <div style="background:#f9fafb;border-radius:8px;padding:12px 14px">
        ...
        <div style="display:flex;justify-content:space-between;font-size:13px;padding:6px 0;margin-top:2px"><span style="color: #f97316;font-weight:700">Profit</span><span style="color: #f97316;font-weight:700">+₹20 per share</span></div>
      </div>
    </div>
  </div>
...
<div class="po-tif-grid">
  <div class="po-tif-card">
    <div class="po-tif-badge" style="background: #f97316">Concentrated Risk</div>
  ...
  <div class="po-tif-card">
    <div class="po-tif-badge" style="background: #f97316">Diversified</div>
