...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:14px;margin:16px 0 24px">
  ...
  <div style="border:1.5px solid #fed7aa;border-radius:12px;overflow:hidden">
    <div style="background:#ff6b00;padding:10px 16px;color:#fff;font-weight:700;font-size:13px">Trigger Price</div>
    <div style="padding:14px 16px;background:#ffffff">
      <p style="font-size:13px;color: #374151;margin:0 0 8px">Market price that activates the GTT order.</p>
      <code style="font-size:12px;color:#b45309">₹2,750 → order fires</code>
    </div>
  </div>

  <div style="border:1.5px solid #fed7aa;border-radius:12px;overflow:hidden">
    <div style="background:#ff6b00;padding:10px 16px;color:#fff;font-weight:700;font-size:13px">Order Price</div>
    <div style="padding:14px 16px;background:#ffffff">
      <p style="font-size:13px;color:#374151;margin:0 0 8px">The actual price placed at exchange after trigger.</p>
      <code style="font-size:12px;color:#b45309">Limit ₹2,748</code>
    </div>
  </div>

  <div style="border:1.5px solid #fed7aa;border-radius:12px;overflow:hidden">
    <div style="background:#ff6b00;padding:10px 16px;color:#fff;font-weight:700;font-size:13px">Quantity</div>
    <div style="padding:14px 16px;background:#ffffff">
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin:16px 0 24px">
  ...
  <div style="border:1.5px solid #fed7aa;border-radius:12px;overflow:hidden">
    <div style="background:#ff6b00;padding:10px 16px;color:#fff;font-weight:700;font-size:13px">Example 1 — Buy GTT</div>
    <div style="padding:14px 16px;background:#ffffff">
...
<div style="display:grid;grid-template-columns:1fr auto 1fr;gap:0;align-items:stretch;margin:16px 0 24px;border:1.5px solid #e5e7eb;border-radius:12px;overflow:hidden">
  ...
  <div style="padding:16px 10px;background: #ffffff;text-align:center;font-size:20px;color: #6b7280;display:flex;align-items:center">→</div>
  <div style="padding:16px 20px;background: #faf4ea">
