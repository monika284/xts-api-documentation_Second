...
<div style="margin:18px 0 20px">
  ...
  <div style="display:flex;align-items:center;gap:0;border:1.5px solid #e5e7eb;border-radius:8px;overflow:hidden">
    ...
    <span style="flex:1;padding:9px 14px;font-family:Consolas,monospace;font-size:12.5px;color:#374151;word-break:break-all" id="inst-quote-url">https://xts.rmoneyindia.co.in:3000/apimarketdata/instruments/quotes</span>
...
&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#9cdcfe">ins</span><span style="color:#d4d4d4"> = [{</span><span style="color:#ce9178">"exchangeSegment"</span><span style="color:#d4d4d4">:</span><span style="color:#b5cea8">1</span><span style="color:#d4d4d4">,</span><span style="color:#ce9178">"exchangeInstrumentID"</span><span style="color:#d4d4d4">:</span><span style="color:#b5cea8">26000</span><span style="color:#d4d4d4">}]</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#9cdcfe">resp</span><span style="color:#d4d4d4"> = </span><span style="color:#c586c0">await</span><span style="color:#d4d4d4"> xt_market_data.</span><span style="color:#dcdcaa">get_quote</span><span style="color:#d4d4d4">(</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#9cdcfe">Instruments</span><span style="color:#d4d4d4">=ins, </span><span style="color:#9cdcfe">xtsMessageCode</span><span style="color:#d4d4d4">=</span><span style="color:#b5cea8">1502</span><span style="color:#d4d4d4">, </span><span style="color:#9cdcfe">publishFormat</span><span style="color:#d4d4d4">=</span><span style="color:#ce9178">"JSON"</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#d4d4d4">)</span><br>
